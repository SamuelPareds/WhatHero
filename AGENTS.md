...
## Preferencia de entrega al terminar una tarea

- Al culminar cada tarea, incluir en la respuesta final un título de commit en español que represente la tarea realizada y un breve resumen de los cambios.
- El usuario realiza los commits manualmente; entregar el título como sugerencia y no ejecutar el commit.
